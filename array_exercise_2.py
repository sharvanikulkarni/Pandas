...
print("-----------------------------------------------   STEP ONE   -----------------------------------------------")
sales_sum=salesArray.sum()
print(sales_sum)
print()

## Step 2: What was Superstore's smallest and largest sale? Print them.
print("-----------------------------------------------   STEP TWO   -----------------------------------------------")
sales_min = salesArray.min()
sales_max = salesArray.max()
print(sales_min)
print(sales_max)
print()
...
print("-----------------------------------------------   STEP THREE  -----------------------------------------------")
greaterthan100 = salesArray >= 100
greaterthan100for = (salesArray[salesArray >= 100])
print(greaterthan100)
print()

## Step 4: Print the total sales for each register.
print("-----------------------------------------------   STEP FOUR   -----------------------------------------------")
TotalSalesRegister=salesArray.sum(axis=1)
print(TotalSalesRegister)
print()
...
print("-----------------------------------------------   STEP FIVE  -----------------------------------------------")
interestRates = (salesArray * 0.02)
#transposeinterest = interestRates.T
print(interestRates)
print()
totalsuminterest=interestRates.sum()
print(totalsuminterest)
...
print("-----------------------------------------------   STEP SIX  -----------------------------------------------")
profit = salesArray - interestRates
print(profit)
print()
...
secondregister = salesArray[1, :]
forthregister = salesArray[3, :]
